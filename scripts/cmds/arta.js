...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (!mention) return api.sendMessage("‎●───༆🌺●───༆༊🦋\n\n🐰✨𝐭𝐡𝐢𝐬\n𝐚𝐛𝐨𝐮𝐭 𝐥𝐢𝐧𝐞!-💜💭\n\n prince ...⚡বস তুমি কোন মেয়েকে ভালোবাসা দিতে চাও মেনশন দাও 🌛😇", event.threadID);
    ...
    const messages = [
      ...
      ` ‎ 🥺💫🌧️\n\n\n\n prince ....⚡ বসের ভালোবাসা শেষ হয়না পাগল এগুলো সামান্য নমুনা.... প্রিন্স বস নিঃসন্দেহে তোমাকে অনেক ভালোবাসে..! আর এটা‌ ছিলো সামান্য নমুনা 🥺💚💫${name}`,
    ];
